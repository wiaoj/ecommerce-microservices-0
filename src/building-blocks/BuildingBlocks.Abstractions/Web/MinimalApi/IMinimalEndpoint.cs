...
public interface IMinimalEndpoint<TResult> : IMinimalEndpoint {
	public Task<TResult> HandleAsync(HttpContext context);
}

public interface IMinimalEndpoint<in TRequest, TResult> : IMinimalEndpoint {
	public Task<TResult> HandleAsync(HttpContext context, TRequest request, CancellationToken cancellationToken);
}
