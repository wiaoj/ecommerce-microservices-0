...
public static class ConfigurationExtensions {
	...
	public static TOptions BindOptions<TOptions>(this IConfiguration configuration, String section) where TOptions : new() {
		...
		IConfigurationSection optionsSection = configuration.GetSection(section);
	...
	/// <param name="configuration">The configuration instance to bind.</param>
	/// <returns>The new instance of <typeparamref name="TOptions"/>.</returns>
	public static TOptions BindOptions<TOptions>(this IConfiguration configuration) where TOptions : new() {
